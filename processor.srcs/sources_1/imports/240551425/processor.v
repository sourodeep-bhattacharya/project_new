...
module processor(
  ...
  // execute
   ...
   // pwm
   wire ctrl_pwm1;
   assign ctrl_pwm1 = (newInstruction[31:27] === 5'b01001);
   wire ctrl_pwm2;
   assign ctrl_pwm2 = (newInstruction[31:27] === 5'b01010);
   ...
   assign gyroInstr = (lastInstruction[31:27] == 5'b01011) ? 1'b1 : 1'b0;
    assign gyroWrite[31:15] = 17'b0;
    assign gyroWrite[14:0] = gyro;
   ...
   assign data_writeReg = gyroInstr ? gyroWrite : setx1 ? value : writeBack;
